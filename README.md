...
- For the most accurate Codex token usage, configure the official Codex OTel JSON log exporter to `http://localhost:4319/integrations/codex/otel/v1/logs`; Codex hook-only prompt/output token counts are estimated locally and marked as estimated.
