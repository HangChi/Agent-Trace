...
export type TokenTracePeriod = "day" | "week" | "month";
export type TokenTraceAggregatePeriod = Exclude<TokenTracePeriod, "day">;
...
export function parseTokenTracePeriod(value: SearchParamValue): TokenTracePeriod {
  const raw = Array.isArray(value) ? value[0] : value;
