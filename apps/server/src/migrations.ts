...
const migrations: Migration[] = [
  ...
  (sqlite) => {
    sqlite.exec(`
      ...
      CREATE INDEX IF NOT EXISTS replay_tasks_source_run_created_at_idx
        ON replay_tasks(source_run_id, created_at DESC);
      CREATE INDEX IF NOT EXISTS replay_tasks_status_created_at_idx
