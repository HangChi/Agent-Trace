...
export const copy = {
  zh: {
    common: {
      ...
      themeDark: "\u5207\u6362\u5230\u6df1\u8272\u4e3b\u9898",
      settings: "\u8bbe\u7f6e",
      settingsDescription: "\u8c03\u6574\u8ffd\u8e2a\u53f0\u7684\u663e\u793a\u4e0e\u5237\u65b0\u65b9\u5f0f\u3002",
      appearance: "\u5916\u89c2",
      appearanceDescription: "\u9009\u62e9\u9002\u5408\u5f53\u524d\u73af\u5883\u7684\u754c\u9762\u4e3b\u9898\u3002",
      themeSystem: "\u8ddf\u968f\u7cfb\u7edf",
      themeLightLabel: "\u6d45\u8272",
      themeDarkLabel: "\u6df1\u8272",
      language: "\u663e\u793a\u8bed\u8a00",
      languageDescription: "\u8bbe\u7f6e\u9875\u9762\u4e0e\u64cd\u4f5c\u6587\u6848\u7684\u8bed\u8a00\u3002",
      liveRefresh: "\u81ea\u52a8\u5237\u65b0",
      liveRefreshDescription: "\u6bcf 2 \u79d2\u66f4\u65b0\u8fd0\u884c\u5217\u8868\u548c\u8ffd\u8e2a\u8be6\u60c5\u3002",
      liveRefreshOn: "\u5df2\u5f00\u542f",
      liveRefreshOff: "\u5df2\u6682\u505c",
      settingsLocalNote: "\u504f\u597d\u4ec5\u4fdd\u5b58\u5728\u5f53\u524d\u8bbe\u5907\uff1bAgent \u8ffd\u8e2a\u6570\u636e\u59cb\u7ec8\u4fdd\u7559\u5728\u672c\u673a\u3002",
      unavailable: "Collector \u4e0d\u53ef\u7528\uff1a"
    },
    tokenTrace: {
      eyebrow: "Token 用量与成本",
      title: "Token-Trace",
      subtitle: "在统计概览与 UTC Token 日历中查看本地 Run 用量、成功率和估算成本。",
      overview: "统计概览",
      calendar: "Token 日历",
      totalTokens: "总 Token",
      estimatedCost: "估算成本",
      clients: "客户端数",
      models: "模型数",
      recentTrend: "日度 Token 趋势",
      recentTrendHelp: "按 UTC 日期展示最近 90 天的 Token 变化。",
      noTrendData: "最近 90 天暂无 Run 或 Token 数据。",
      trendUnavailable: "趋势分析暂不可用。",
      activeDays: "活跃天数",
      dailyAverage: "日均 Token",
      dailyTokenUsage: "当日 Token",
      peakDay: "峰值日期",
      weeklyStatistics: "周度 Token 统计",
      weeklyStatisticsHelp: "按周一至周日汇总最近 90 天的 Token。",
      monthlyStatistics: "月度 Token 统计",
      monthlyStatisticsHelp: "按自然月汇总最近 90 天的 Token。",
      tokenHeat: "Token 热度",
      monthSummary: "月度摘要",
      monthSummaryHelp: "按 Run 的 UTC 日期汇总 Token、成本与成功率。",
      runs: "Run 数",
      successRate: "成功率",
      previousMonth: "上个月",
      nextMonth: "下个月",
      latestMonth: "当前月份",
      utcWindow: "UTC · 最近 90 天",
      noMonthActivity: "本月暂无活动",
      tokens: "Token",
      cost: "成本",
      weekdays: ["周一", "周二", "周三", "周四", "周五", "周六", "周日"]
    },
    runs: {
      consoleLabel: "\u672c\u5730 Agent \u53ef\u89c2\u6d4b\u6027",
      title: "Agent \u8ffd\u8e2a\u53f0",
      subtitle:
        "\u96c6\u4e2d\u67e5\u770b Agent \u7684\u547d\u4ee4\u3001\u5de5\u5177\u8c03\u7528\u3001Skills\u3001MCP \u4e0e Token \u6d88\u8017\uff0c\u5feb\u901f\u8fd8\u539f\u6267\u884c\u8def\u5f84\uff0c\u5b9a\u4f4d\u5f02\u5e38\u4e0e\u91cd\u590d\u64cd\u4f5c\u3002",
      allRuns: "\u5168\u90e8\u8fd0\u884c",
  ...
  en: {
    common: {
      ...
      settings: "Settings",
      settingsDescription: "Adjust how the trace console looks and refreshes.",
      appearance: "Appearance",
      appearanceDescription: "Choose a theme that fits your current environment.",
      themeSystem: "System",
      themeLightLabel: "Light",
      themeDarkLabel: "Dark",
      language: "Display language",
      languageDescription: "Set the language used by pages and controls.",
      liveRefresh: "Live refresh",
      liveRefreshDescription: "Update run lists and trace details every 2 seconds.",
      liveRefreshOn: "On",
      liveRefreshOff: "Paused",
      settingsLocalNote: "Preferences stay on this device. Agent trace data remains local.",
      unavailable: "Collector unavailable: "
    },
    tokenTrace: {
      eyebrow: "Token usage and cost",
      title: "Token-Trace",
      subtitle: "Inspect local run usage, success rates, and estimated cost across an overview and UTC token calendar.",
      overview: "Overview",
      ...
      clients: "Clients",
      models: "Models",
      recentTrend: "Daily token trend",
      recentTrendHelp: "Token usage by UTC date across the latest 90 days.",
      noTrendData: "No runs or token usage in the latest 90 days.",
      trendUnavailable: "Trend analysis is unavailable.",
      activeDays: "Active days",
      dailyAverage: "Daily average",
      dailyTokenUsage: "Daily tokens",
      peakDay: "Peak day",
      weeklyStatistics: "Weekly token totals",
      weeklyStatisticsHelp: "Aggregated Monday through Sunday across the latest 90 days.",
      monthlyStatistics: "Monthly token totals",
      monthlyStatisticsHelp: "Aggregated by calendar month across the latest 90 days.",
      tokenHeat: "Token heat",
      monthSummary: "Monthly summary",
      monthSummaryHelp: "Aggregated by each run's UTC date, including tokens, cost, and success rate.",
      runs: "Runs",
      successRate: "Success rate",
      previousMonth: "Previous month",
      nextMonth: "Next month",
      latestMonth: "Current month",
      utcWindow: "UTC · Latest 90 days",
      noMonthActivity: "No activity this month",
      tokens: "Tokens",
      cost: "Cost",
      weekdays: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]
    },
    runs: {
      consoleLabel: "Local agent observability",
      title: "Agent Trace Console",
      subtitle:
        "Inspect agent commands, tool calls, skills, MCP activity, and token usage in one place, then retrace execution paths and find failures faster.",
      allRuns: "All runs",
      ...
      tableScrollHint: "Swipe horizontally to inspect all run fields",
      tableError: "Error",
